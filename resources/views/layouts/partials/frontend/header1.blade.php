            ...
            <div class="row align-items-center">
                <div class="col-md-3 col-sm-6 pl-0">
                    <a href="{{url('/')}}" class="py-3">
                        <img class="mw-100" src="{{ asset('upload/images/logo/'.config('siteSetting.logo'))}}" alt="logo">
                    </a>
                </div>
       
                <div class="col-md-7">
                    <form action="{{route('home.category')}}" method="get" class="w-100 d-flex align-items-center bb2 rounded yb">
                        <input type="text" id="searchKey" value="{{ Request::get('q') }}" name="q" class="searchKey w-100 p-3 rounded-l" placeholder="What are you looking for?">
                        <button type="submit" class="contents">
                            <img class="px-2" src="{{ asset('upload/images/search-y.png')}}" alt="search">
                        </button>
                    </form>
                    <div class="d-flex align-items-center justify-content-center mt-1 mb-n4">
                        <b class="mr-2">Live Ads : </b>
                        <b class="pt">{{ App\Models\Product::where("status", "active")->count() }}</b>
                    </div>
                </div>
                        ...
                        <div class="d-flex justify-content-end py-2 icon-size">
                            <ul class="d-flex justify-content-end">
                                ...
                                class="mr-3">
                                    <button type="button" class="border-r pr-2">
                                        <img width="25" height="25" src="{{ asset('upload/images/Language.png')}}" alt="logo">
                                    </button>
                                    @if(Auth::check())
                                ...
                                class="mr-3">
                                    <button type="button" class="border-r pr-2">
                                        <img width="25" height="25" src="{{ asset('upload/images/chat.png')}}" alt="logo">
                                    </button>
                                    @if(Auth::check())
                            ...
                            <div class="btn-group user">
                              <button type="button" class="border-none p-0 btn dropdown-toggle users" data-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false">
                                  <img width="25" height="25" src="{{ asset('upload/users') }}/{{(Auth::user()->photo) ? Auth::user()->photo : 'default.png'}}" alt="user">
                              </button>
                            ...
                            @else
                            <a href="{{route('login')}}">
                                <img width="25" height="25" src="{{ asset('upload/images/user.png')}}" alt="logo">
                            </a>
                            @endif
                        </div>
                        <a
    ...
    <div class="container">
        <div class="d-flex align-items-center">
            <a href="javascript:history.back()" class="home mr-2">
                <img class="mw-100" width="30" height="25" src="{{ asset('upload/images/left-arrow.png')}}" alt="logo">
            </a>
            <a href="{{url('/')}}" class="py-3">
                <img class="mw-100" src="{{ asset('upload/images/mlogo.png')}}" alt="logo">
            </a>
        </div>
    </div>
</header>
<nav class="mobile-nav">
    <div class="container">
        <div class="mobile-group">
            ...
            <a href="{{route('wishlists')}}" class="mobile-widget">
                <i class="fa fa-heart"></i>
                <span>Saved</span>
            </a>
            <a  @if(Auth::check()) href="{{route('post.create')}}" @else data-toggle="modal" data-target="#so_sociallogin" href="javascript:void(0)" @endif  class="mobile-widget plus-btn">
                <i class="fa fa-plus"></i>
                <span>Ad Post</span>
            </a>
            <a href="{{route('allNotifications')}}" class="mobile-widget">
