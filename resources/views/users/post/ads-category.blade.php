...
<div class="container bg-white mb-5 px-0">
    ...
    <div id="box2" class="box w-100 py-3" style="display: none;">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                ...
                <input type="date" required min="{{date('Y-m-d')}}" name="start_date" id="start_date" placeholder="link" class="mt-2 w-100 borders p-2 gb shadow-b rounded-3">
                <label class="my-2" for="">End date</label>
                <input type="date" required min="{{Carbon\Carbon::parse(now())->addDay()->format('Y-m-d')}}" name="end_date" id="end_date" placeholder="link" class="mt-2 w-100 borders p-2 gb shadow-b rounded-3">
    ...
    <div id="box3" class="box w-100 py-3" style="display: none;">
        <form action="{{ route('storeWantedPost')}}" data-parsley-validate method="post" enctype="multipart/form-data">
        @csrf
