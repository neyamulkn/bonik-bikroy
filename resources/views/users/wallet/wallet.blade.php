...
@endsection
@section('content')
	@php $withdrawStatus = App\Models\SiteSetting::where('type', 'customer_withdraw_configure')->where('status', 1)->first(); @endphp
	...
	<div class="container">
		...
		<div class="row">
			...
			<!--Middle Part Start-->
			<div id="content" style="background: transparent;" class="col-md-9 sticky-content">
				...
				<section class="row">
		                ...
		                <div class="card label-default">
		                    <div class="user-box">
		                        <div class="d-flex   no-block align-items-center">
		                            <a href="{{route('customer.walletHistory')}}" class="link ml-auto">{{ config('siteSetting.currency_symble') . Auth::user()->wallet_balance}}</a>
		                        </div>
		            ...
		            <div class="col-md-3 col-xs-6">
		                <div class="card label-default">
		                    <div class="user-box">
		                        <div class="d-flex  no-block align-items-center">
		                            <a href="{{route('customer.walletHistory')}}/?withdraw=pending" class="link ml-auto">{{config('siteSetting.currency_symble') . $wallets->where('type', 'withdraw')->whereIn('status', ['pending','accepted'])->sum('amount')}}</a>
		            ...
		            <div class="col-md-3 col-xs-6">
		                <div class="card label-default">
		                    <div class="user-box">
		                        <div class="d-flex   no-block align-items-center">
		                            <a href="{{route('customer.walletHistory')}}/?withdraw=paid" class="link ml-auto">{{config('siteSetting.currency_symble') . $wallets->where('type', 'withdraw')->where('status', 'paid')->sum('amount')}}</a>
		                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form-row">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('customer.withdraw_request')}}" method="POST" data-parsley-validate>
                            {{csrf_field()}}
                            <div class="form-body">
