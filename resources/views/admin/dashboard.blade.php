                                ...
                                <div class="table-responsive">
                                    <table class="table product-overview">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a target="_blank" href="{{ route('post_details', $product->slug) }}"> <img src="{{asset('upload/images/product/thumb/'.$product->feature_image)}}" alt="Image" width="42"> {{Str::limit($product->title, 30)}}</a> </td>
