                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <input type="text" value="{{$setting->playStore}}" placeholder="Enter playstore link" name="playStore" id="playstore" class="form-control" >
                                                            </div>
                                                            <label class="col-md-2 text-right col-form-label" for="appStore">App Store link</label>
                                                             <div class="col-md-3">
                                                                <input type="text" value="{{$setting->appStore}}" placeholder="Enter app store link" name="appStore" id="appStore" class="form-control" >
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
