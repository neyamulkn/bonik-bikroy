                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody id="categoryPositionSorting">
                                            ...
                                            <tr id="item{{$data->id}}">
                                                ...
                                                <td><input style="width: 100px;" value="{{$data->post_fee}}" onkeyup ="updateData({{$data->id}}, this.value , 'post_fee')" type="number" class="form-control" name=""></td>
                                                <td><input style="width: 100px;" value="{{$data->free_ads_limit}}" onkeyup ="updateData({{$data->id}}, this.value , 'free_ads_limit')" type="number" class="form-control" name=""></td>@endif
                                                <td>{{$data->notes}}</td>
                                                <td> 
                                                     @if($permission['is_edit'])
...
@section('js')
    ...
    $(document).ready(function() {
        ...
        function updateData(category, value, field){
            ...
            var  url = '{{route("admin.updateData")}}';
            if(value){
            $.ajax({
                url:url,
                method:"get",
