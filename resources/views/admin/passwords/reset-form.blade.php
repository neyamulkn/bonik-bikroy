...
@section('title', 'Password Recover | '.Config::get('siteSetting.site_name'))
@section('css-top')
        ...
        <div class="col-md-6 col-xs-12 ">
            <div class="card loginArea">
                <div class="card-body">
                    <div id="loginform">
                        ...
                        <form class="form-horizontal" data-parsley-validate  method="get" id="recoverResetform" action="{{ route('admin.password.recoverVerify') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12" style="line-height: 2">
                                    ...
                                    <a href="{{ route('admin.password.recover') }}?emailOrMobile={{Request::get('mobile')}}"> Send code again</a><br/>
                                    
                                </div>
                            </div>
                        </form>
                        @else      
                        <form class="form-horizontal" data-parsley-validate method="post" id="recoverResetform" action="{{ route('admin.password.recover') }}">
                            @csrf 
                            <div class="row">      
                                <div class="col-xs-12">
            ...
            <div class="actions-toolbar">
                <div class="col-sm-12 text-center">
                    Back to login <a href="{{route('adminLoginForm')}}" class="text-info m-l-5"><b>Login</b></a>
                </div>
            </div>  
            <div class="col-md-3 col-xs-12"></div>     
        </div>
