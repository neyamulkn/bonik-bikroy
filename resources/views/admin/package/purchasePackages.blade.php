                                    ...
                                    @if(count($packages)>0)
                                        ...
                                        <tr id="{{$package->package_id}}" @if($package->order_status == 'cancel') style="background:#ff000026" @endif >
                                           ...
                                           <td>
                                            ...
                                            <img width="30" src="{{asset('upload/images/package/'.$package->get_package->ribbon)}}"> {{ $package->get_package->name }}
                                             <p style="font-size: 12px;margin: 0;padding: 0">
                                                {{\Carbon\Carbon::parse($package->created_at)->format(Config::get('siteSetting.date_format'))}} <br/>
                                           {{\Carbon\Carbon::parse($package->created_at)->format('h:i:s A')}}</p> @endif
                                            </td>
                                           <td>{{ $package->customer_name }}
                                            ...
                                            <td>
                                                ...
                                                <span class="mytooltip tooltip-effect-2">
                                                <div @if($permission['is_edit']) @if($package->payment_status != 'paid') onclick="orderPaymentPopup('{{ route("packagePaymentDetails", $package->id)}}')"  @endif  @endif  title="package payment info" data-toggle="tooltip"  class="text-inverse p-r-10" >{{$package->payment_status}} </div>
                                                </span>
                                                </a>
