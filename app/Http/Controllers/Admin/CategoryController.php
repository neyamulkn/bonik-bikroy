...
class CategoryController extends Controller
{
    ...
    public function category_store(Request $request)
    {
        ...
        $data->ua_1 = $request->ua_1;
        $data->ua_2 = $request->ua_2;
        $data->ua_3 = $request->ua_3;
        
        $data->pa_1 = $request->pa_1;
        $data->pa_2 = $request->pa_2;
        $data->pa_3 = $request->pa_3;
        
        $data->ha_1 = $request->ha_1;
        $data->ha_2 = $request->ha_2;
        $data->ha_3 = $request->ha_3;
        
        $data->fa_1 = $request->fa_1;
        $data->fa_2 = $request->fa_2;
        
        $data->ba_1 = $request->ba_1;
        $data->ba_2 = $request->ba_2;
        $data->ba_3 = $request->ba_3;

        if ($request->hasFile('phato')) {
            $image = $request->file('phato');
            $new_image_name = rand() . '.' . $image->getClientOriginalExtension();

            $image_hath = public_hath('upload/images/category/thumb/' . $new_image_name);
