<aside style="display: none; background: #fff;padding-top: 10px; box-shadow: 0 2px 4px 0 rgb(0 0 0 / 25%);transform: scale(1.0);" class="user-sidebar content-aside right_column sidebar-offcanvas">
        ...
        <div class="module-content custom-border ">
            <ul class="list-box">
                ...
                <li><a href="<?php echo e(route('linkAds')); ?>"><i class="fa fa-clipboard-list"></i> Link Ads</a></li>
...
<?php /**PATH C:\xampp\htdocs\bonik\resources\views/layouts/partials/frontend/user-sidebar.blade.php ENDPATH**/ ?>