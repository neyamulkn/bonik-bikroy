...
<!-- CUSTOM -->
<script src="<?php echo e(asset('frontend')); ?>/js/custom/slick.js"></script>
<script src="<?php echo e(asset('frontend')); ?>/js/custom/main.js"></script>
...
<script>
    ...
    <?php if(Auth::check()): ?> 
        ...
        function readNotify(id){
            ...
            var url = "<?php echo e(route('readNotify', ':id')); ?>";
        ...
        function countMessageNotification(){
            $.ajax({
            url:'<?php echo e(route("countMessageNotification")); ?>',
            type:'get',
            success:function(data){
                if(data){
                    $('.countMessages').html(data.messages);
                    $('.countNotifications').html(data.notifications);
                }
            }
          });
        }
        setInterval(function(){countMessageNotification();}, 5000);
...
</script><?php /**PATH C:\xampp\htdocs\jotesto\resources\views/layouts/partials/frontend/scripts.blade.php ENDPATH**/ ?>