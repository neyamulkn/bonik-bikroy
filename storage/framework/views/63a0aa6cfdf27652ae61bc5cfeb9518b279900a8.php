                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody id="categoryPositionSorting">
                                            ...
                                            <tr id="item<?php echo e($data->id); ?>">
                                                ...
                                                <td><input style="width: 100px;" value="<?php echo e($data->post_fee); ?>" onkeyup ="updateData(<?php echo e($data->id); ?>, this.value , 'post_fee')" type="number" class="form-control" name=""></td>
                                                <td><input style="width: 100px;" value="<?php echo e($data->free_ads_limit); ?>" onkeyup ="updateData(<?php echo e($data->id); ?>, this.value , 'free_ads_limit')" type="number" class="form-control" name=""></td><?php endif; ?>
...
<?php $__env->startSection('js'); ?>
    ...
    $(document).ready(function() {
        ...
        // free Ads Limit
        function updateData(category, value, field){
            
            var  url = '<?php echo e(route("admin.updateData")); ?>';
            if(value){
            $.ajax({
                url:url,
                method:"get",
                data:{value:value,category:category,field:field},
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jotesto\resources\views/admin/category/subcategory.blade.php ENDPATH**/ ?>