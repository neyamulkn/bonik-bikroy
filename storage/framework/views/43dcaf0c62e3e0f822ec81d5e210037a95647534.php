                                    ...
                                    <div class="row justify-content-md-center">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input  name="ua_1" id="ua_1" value="100" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="ua_2">7 days</label>
                                                <input  name="ua_2" id="ua_2" value="200" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="ua_3">15 days</label>
                                                <input  name="ua_3" id="ua_3" value="350" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-md-center">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input  name="pa_1" id="pa_1" value="150" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="pa_2">7 days</label>
                                                <input  name="pa_2" id="pa_2" value="300" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="pa_3">15 days</label>
                                                <input  name="pa_3" id="pa_3" value="500" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-md-center">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input  name="ha_1" id="ha_1" value="200" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="ha_2">7 days</label>
                                                <input  name="ha_2" id="ha_2" value="400" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="ha_3">15 days</label>
                                                <input  name="ha_3" id="ha_3" value="700" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-md-center">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input  name="fa_1" id="fa_1" value="50" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="fa_2">3 days</label>
                                                <input  name="fa_2" id="fa_2" value="150" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-md-center">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input  name="ba_1" id="ba_1" value="400" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="ba_2">7 days</label>
                                                <input  name="ba_2" id="ba_2" value="800" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="ba_3">15 days</label>
                                                <input  name="ba_3" id="ba_3" value="1400" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bonik\resources\views/admin/category/category.blade.php ENDPATH**/ ?>