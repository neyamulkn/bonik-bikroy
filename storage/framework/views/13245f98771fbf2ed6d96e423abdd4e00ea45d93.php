                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="item<?php echo e($customer->id); ?>">
                                            ...
                                            <td> <?php if($customer->sellerVerify && $customer->sellerVerify->status == "active"): ?> <span class="label label-success"> Verified </span><?php elseif($customer->sellerVerify && $customer->sellerVerify->status == 'pending'): ?> <span class="label label-info"><?php echo e($customer->sellerVerify->status); ?></span> <?php elseif($customer->sellerVerify): ?> <span class="label label-danger"><?php echo e($customer->sellerVerify->status); ?></span> <?php else: ?> <span class="label label-danger">Unverify</span> <?php endif; ?></td>
                                            <td>
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bonik\resources\views/admin/customer/customer.blade.php ENDPATH**/ ?>