        ...
        <div class="container-fluid">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="item<?php echo e($customer->id); ?>">
                                            <td><?php echo e((($sellerMemberships->perPage() * $sellerMemberships->currentPage() - $sellerMemberships->perPage()) + ($index+1) )); ?></td>
                                            ...
                                            <td>
                                                ...
                                                <p style="padding-left: 3px"><?php echo e($customer->user->name); ?></p>
                                                </a>
                                            </td>
                                            <td><?php echo e($customer->user->mobile); ?> <br/> <?php echo e($customer->user->email); ?></td> 
                                           
                                            <td><?php echo e(str_replace("-", " ", $customer->membership)); ?> </td>
                                            ...
                                            <td onclick="customerStatus(<?php echo e($customer->id); ?>)"> <?php if($customer->status == 'active'): ?> <span class="label label-success"> Active </span> <?php else: ?> <span class="label label-danger"><?php echo e($customer->status); ?></span> <?php endif; ?></td>
            ...
            <div class="row">
               <div class="col-sm-6 col-md-6 col-lg-6 text-center">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 text-right">Showing <?php echo e($sellerMemberships->firstItem()); ?> to <?php echo e($sellerMemberships->lastItem()); ?> of total <?php echo e($sellerMemberships->total()); ?> entries (<?php echo e($sellerMemberships->lastPage()); ?> Pages)</div>
            </div>
            <!-- ============================================================== -->
            <!-- End PAge Content -->
            <!-- ============================================================== -->
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bonik\resources\views/admin/customer/membershipRequest.blade.php ENDPATH**/ ?>