                                           ...
                                           <td>
                                            ...
                                            <img width="30" src="<?php echo e(asset('upload/images/package/'.$package->get_package->ribbon)); ?>"> <?php echo e($package->get_package->name); ?>
                                             ...
                                             <p style="font-size: 12px;margin: 0;padding: 0">
                                                <?php echo e(\Carbon\Carbon::parse($package->package_date)->format(Config::get('siteSetting.date_format'))); ?> <br/>
                                           <?php echo e(\Carbon\Carbon::parse($package->package_date)->format('h:i:s A')); ?></p> <?php endif; ?>
                                            </td>
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jotesto\resources\views/admin/package/purchasePackages.blade.php ENDPATH**/ ?>