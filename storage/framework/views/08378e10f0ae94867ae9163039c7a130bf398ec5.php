...
.indigo-accordion-theme ul .accordion-title:hover { background:#f76d62; }
        	...
        	<div class="row">
        		...
        		<p>CHOOSE A CATEGORY</p>
		       	<ul class="mdn-accordion indigo-accordion-theme">
		            ...
		            <li class="sub-level">
		                <input class="accordion-toggle" type="checkbox" id="category<?php echo e($category->id); ?>">
		                <label class="accordion-title" for="category<?php echo e($category->id); ?>"> <i><img width="50" src="<?php echo e(asset('upload/images/category/thumb/'.$category->image)); ?>"></i> <?php echo e($category->name); ?> </label>
		                <ul>
		                    ...
		                    <li><a href="<?php echo e(route('post.create', [$category->slug, $subcategory->slug])); ?>"><?php echo e($subcategory->name); ?></a></li>
		                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		                </ul>
		            </li>
		            <?php else: ?>
		            <li><a href="<?php echo e(route('post.create', $category->slug)); ?>"><i><img width="30" src="<?php echo e(asset('upload/images/category/thumb/'.$category->image)); ?>"></i> <?php echo e($category->name); ?> </a></li>
		            <?php endif; ?>
		            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		       	</ul>
			    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jotesto\resources\views/users/post/ads-category.blade.php ENDPATH**/ ?>