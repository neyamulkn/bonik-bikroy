                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="item<?php echo e($customer->id); ?>">
                                            ...
                                            <td>
                                                <?php if($customer->trade_license): ?> <a class="popup-gallery" href="<?php echo e(asset('upload/users/'.$customer->trade_license)); ?>"><img width="50" src="<?php echo e(asset('upload/users/'.$customer->trade_license)); ?>"></a><?php endif; ?> 
                                                <?php if($customer->trade_license2): ?> <a class="popup-gallery" href="<?php echo e(asset('upload/users/'.$customer->trade_license2)); ?>"><img width="50" src="<?php echo e(asset('upload/users/'.$customer->trade_license2)); ?>"></a><?php endif; ?>
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bonik\resources\views/admin/customer/verifyRequest.blade.php ENDPATH**/ ?>