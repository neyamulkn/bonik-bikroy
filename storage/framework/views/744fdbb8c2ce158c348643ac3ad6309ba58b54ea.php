    ...
    <div class="col-lg-12 spotlight">
        <div class="ad-feature-slider slider-arrow" >
            ...
            <div class="feature-card" >
                ...
                <button type="button" <?php if(Auth::check()): ?> onclick="addToWishlist(<?php echo e($spotlight->get_adPost->id); ?>)" data-toggle="tooltip" <?php else: ?> data-toggle="modal" data-target="#so_sociallogin" <?php endif; ?> class="feature-wish">
                    <i class="fas fa-heart <?php if($spotlight->get_adPost->wishlist): ?> fas <?php endif; ?>"></i>
                </button>

                <?php if($spotlight->get_adPackage): ?>
                <span style="position:absolute;top: 0px;left: -4px;"><img style="width:90px" src="<?php echo e(asset('upload/images/package/'.$spotlight->get_adPackage->ribbon)); ?>"></span><?php endif; ?>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jotesto\resources\views/frontend/post-filter.blade.php ENDPATH**/ ?>