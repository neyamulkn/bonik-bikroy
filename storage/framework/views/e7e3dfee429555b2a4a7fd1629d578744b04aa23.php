                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody id="categoryPositionSorting">
                                            ...
                                            <tr id="item<?php echo e($data->id); ?>">
                                                ...
                                                <td><img src="<?php echo e(asset('upload/images/category/thumb/'. $data->image)); ?>" alt="" width="50"></td>
                                                ...
                                                <td>
                                                    ...
                                                    <button data-target="#delete" onclick="deleteConfirmPopup('<?php echo e(route("subchildcategory.delete", $data->id)); ?>')" class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i> Delete</button><?php endif; ?>
                                                </td>
                                            </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
            ...
            <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body form-row">
                        <div class="card-body">
                            <form action="<?php echo e(route('subchildcategory.store')); ?>" enctype="multipart/form-data" method="POST">
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bonik\resources\views/admin/category/sub-childcategory.blade.php ENDPATH**/ ?>