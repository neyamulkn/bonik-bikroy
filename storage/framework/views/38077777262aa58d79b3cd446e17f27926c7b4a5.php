                    ...
                    <div class="accordion w-100" id="accordion">
                        <div class="bg-white mb-3">
                            ...
                            <div id="collapseOne" class="collapse show p-2" role="tabpanel" aria-labelledby="headingOne">
                                <div class="d-flex align-items-center">
                                    <input type="checkbox" name="ad" value="pin" <?php if(in_array("pin", explode(',', Request::get('ad')))): ?> checked <?php endif; ?> class="common_selector package" id="Pin">
                                    <label class="iy" for="Pin">Pin Ad</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="checkbox" name="ad" id="Urgent" <?php if(in_array("urgent", explode(',', Request::get('ad')))): ?> checked <?php endif; ?> class="common_selector package" value="urgent">
                                    <label class="iy" for="Urgent">Urgent Ad</label>
                                </div>
                                
                                <div class="d-flex align-items-center">
                                    <input type="checkbox" name="ad" value="highlight" <?php if(in_array("highlight", explode(',', Request::get('ad')))): ?> checked <?php endif; ?> class="common_selector package" id="highlight">
                                    <label class="iy" for="highlight">Highlight Ad</label>
                                </div>
                                <div class="d-flex align-items-center">
                                    <input type="checkbox" name="ad" value="fast" <?php if(in_array("fast", explode(',', Request::get('ad')))): ?> checked <?php endif; ?> class="common_selector package" id="fast">
