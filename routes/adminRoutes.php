...
//reset for
Route::get('password/recover', 'Auth\ForgotPasswordController@adminPasswordRecover')->name('admin.password.recover');
//forgot password notify send
Route::match(array('GET','POST'), 'password/recover/notify', 'Auth\ForgotPasswordController@adminPasswordRecoverNotify')->name('admin.password.recover');
//verify token or otp
Route::get('password/recover/verify', 'Auth\ForgotPasswordController@adminPasswordRecoverVerify')->name('admin.password.recoverVerify');
//passord update
Route::post('password/recover/update', 'Auth\ForgotPasswordController@adminPasswordRecoverUpdate')->name('admin.password.recoverUpdate');
...
Route::group(['middleware' => ['auth:admin', 'admin']], function(){
	...
	//clear all storage session & cookie
...
Route::group(['middleware' => 'auth:admin', 'namespace' => 'Admin'], function(){
	...
	Route::get('post/{statusType?}', 'ProductController@index')->name('admin.product.list');
